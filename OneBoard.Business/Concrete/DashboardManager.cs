...
{
    public class DashboardManager : BaseService<IDashboardDal, Dashboard>, IDashboardService
    {
        ...
        public IDataResult<Dashboard> GetById(int Id)
        {
            try
            {
                return new SuccessDataResult<Dashboard>(_dal.Find(Id),
                    BasicCrudOperationMessages.SUCCESS_GET_ID);
            }
            catch (Exception e)
            {

                return new FailDataResult<Dashboard>(e.Message);
            }
        }
        ...
        public IDataResult<IQueryable<Dashboard>> GetEntityQueryable()
        {
            try
            {
                return new SuccessDataResult<IQueryable<Dashboard>>(_dal.GetListByQueryable(), BasicCrudOperationMessages.SUCCESS_GET_LİST);
            }

            catch (Exception e)
            {
                return new FailDataResult<IQueryable<Dashboard>>(e.Message);
            }
        }
        ...
        public IDataResult<List<Dashboard>> GetEntityValues()
        {
            try
            {
                return new SuccessDataResult<List<Dashboard>>(_dal.GetList().ToList(), BasicCrudOperationMessages.SUCCESS_GET_LİST);
            }

            catch (Exception e)
            {
                return new FailDataResult<List<Dashboard>>(e.Message);
            }
        }
        ...
        #region async
        public async Task<IResult> AddAsync(Dashboard entity)
        {
            try
            {
                ...
                return new SuccessDataResult<Dashboard>(entity, BasicCrudOperationMessages.SUCCESS_ADD);
            }
            catch (Exception e)
            {
        ...
        public async Task<IResult> DeleteByIdAsync(int Id)
        {
            try
            {
                Dashboard entity = await _dal.FindByIdAsync(Id);
                if (entity == null)
                {
                    return new FailDataResult<Dashboard>($"{BasicCrudOperationMessages.NOT_FOUND_ENTİTY} :That belonging to {Id} any entity.");
                }
                else
                {
        ...
        public async Task<IDataResult<Dashboard>> FindByIdAsync(int Id)
        {
            try
            {
                Dashboard entity = await _dal.FindByIdAsync(Id);
                ...
                return new SuccessDataResult<Dashboard>(entity, $"{BasicCrudOperationMessages.SUCCESS_GET_ID}");
            }
            catch (Exception ex)
            {
                return new FailDataResult<Dashboard>($"{BasicCrudOperationMessages.FIND_BY_ID_ERROR} :Exception : {ex.Message}");
            }
        }

        public async Task<IDataResult<IList<Dashboard>>> GetEntityValuesAsync()
        {
            try
            {
                //filling entity list
                IEnumerable<Dashboard> entities = await _dal.ListAsync();
                return new SuccessDataResult<IList<Dashboard>>(entities.ToList(), $"{BasicCrudOperationMessages.SUCCESS_GET_LİST}");
            }
            catch (Exception ex)
            {

                return new FailDataResult<IList<Dashboard>>($"There is an error.When it finding the list : {ex.Message}");
            }
        }

        public async Task<IResult> UpdateAsync(Dashboard entity)
        {
            try
            {
